...
class ChatTest(unittest.TestCase):
    ...
    def test_chat(self):
        ...
        try:
            chat.enter_text_chat(self.text)
            chat.click_send_button()
        except Exception:
            chat.click_hello_start_button()
            chat.enter_text_chat(self.text)
            chat.click_send_button()
    ...
    #     except Exception:
    #         chat_not_test.click_hello_start_button()
    #         chat_not_test.enter_text_chat("")
    #         chat_not_test.click_send_like_button()
    ...
    def test_receive_message(self):
        ...
        check_receive.enter_search("xxzznhut nhutzzxx")
        check_receive.click_user_to_chat_button()
        print(check_receive.get_text_message())
        assert check_receive.get_text_message() == self.text